<div align="center">
  ...
  <p><i>I am a software developer focused on building high-performance web applications, designing scalable systems, and learning modern technologies.</i></p>
  ...
  <!-- Aktif Projeler (KART DÜZENİ) -->
  <h3>🚀 Şu An Üzerinde Çalıştığım Projeler / Current Projects</h3>

  <table width="85%" align="center">
    <tr>
      <td align="left" style="padding: 15px;">
        <div align="right">
          <img src="https://img.shields.io/badge/Status-In_Development-38BDF8?style=flat-square" alt="status" />
          <img src="https://img.shields.io/badge/Access-Private_Repo-4B5563?style=flat-square" alt="private" />
        </div>
        <h4>🚙 YETE Filo — Araç & Servis Yönetim Sistemi</h4>
        <p>Modern yazılım prensipleri doğrultusunda .NET 8 Clean Architecture mimarisi ve MSSQL kullanılarak geliştirilen; yüksek ölçeklenebilirlik, sürdürülebilirlik ve performans odaklı araç filo & servis yönetim backend sistemi.</p>
        <p><i>High-scalability vehicle fleet and service management backend architecture built with .NET 8 Clean Architecture and MSSQL, adhering to enterprise software design patterns.</i></p>
        <br />
        <img src="https://img.shields.io/badge/.NET_8-512BD4?style=flat-square&logo=dotnet&logoColor=white" alt="dotnet" />
        <img src="https://img.shields.io/badge/C%23-239120?style=flat-square&logo=csharp&logoColor=white" alt="csharp" />
        <img src="https://img.shields.io/badge/SQL_Server-CC292B?style=flat-square&logo=microsoftsqlserver&logoColor=white" alt="mssql" />
      </td>
    </tr>
  </table>
